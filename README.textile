...
If you wish, put something like this in config/initializers/formtastic.rb:
...
There's a TextMate bundle dedicated to make usage of Formtastic in the TextMate editor even more of a breeze:
